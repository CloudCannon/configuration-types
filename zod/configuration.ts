...
export const HrefAddOptionSchema = z.object({
	name: z.string()
		.optional()
		.describe("The text displayed for the menu item."),
...
export const CreateSchema = z.object({
	...
	extra_data: z.record(z.string(), z.string())
		.optional()
		.describe(
...
export const SchemaSchema = z.object({
	...
	create: CreateSchema
		.optional()
		.describe("Controls where new files are saved."),

	new_preview_url: z.string()
		.optional()
		.describe(
...
export const CollectionConfigSchema = z.object({
	...
	glob: z.union([z.array(z.string()), z.string()])
		.optional()
		.describe(
	...
	sort_options: z.array(SortOptionSchema)
		.optional()
		.describe(
			"This key defines the options for the Sort dropdown in a _Collection browser_.",
		),
	...
	add_options: z.array(z.union([AddOptionSchema, HrefAddOptionSchema]))
		.optional()
		.describe(
	...
	disable_file_actions: z.boolean()
		.optional()
		.describe(
			"This key toggles whether team members can use the _+ Add_ button in the top right of the _Collection browser_ to add files to a Collection.",
		),
...
export const CollectionGroupSchema = z.object({
	heading: z.string()
		.describe("Short, descriptive label for this group of collections."),
...
export const DataConfigEntrySchema = z.object({
	path: z.string()
		.describe("The path to a file or folder of files containing data."),
});
...
export const CommitTemplateSchema = z.object({
	...
	wrap_width: z.number()
		.optional()
		.describe("Sets the width of the text wrap in the editor."),
});
...
export const ConfigurationSchema = z.object({
	...
	collections_config: z.record(z.string(), CollectionConfigSchema)
		.optional()
		.describe(
	...
	base_url: z.string()
		.optional()
		.describe("The subpath where your output files are hosted."),

	data_config: z.record(z.string(), DataConfigEntrySchema)
		.optional()
		.describe(
			"Controls what data sets are available to populate select and multiselect inputs.",
		),

	file_config: z.array(FileConfigEntrySchema)
		.optional()
		.describe(
	...
	markdown: MarkdownSettingsSchema
		.optional()
		.describe("Contains settings for various Markdown engines."),

	timezone: TimezoneSchema
		.default("Etc/UTC")
		.optional()
		.describe(
			"Specifies the time zone that dates are displayed and edited in.",
		),

	_snippets: z.record(z.string(), SnippetConfigSchema)
		.optional()
	...
	_snippets_templates: z.record(z.string(), SnippetConfigSchema)
		.optional()
		.describe(
			"Extended option used when creating more complex custom snippets.",
		),

	_snippets_definitions: z.record(z.string(), SnippetConfigSchema)
		.optional()
		.describe(
			"Extended option used when creating more complex custom snippets.",
		),
