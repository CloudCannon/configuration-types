...
export const InstanceValueSchema = z.enum(['UUID', 'NOW']).meta({
	name: 'InstanceValue',
	description: 'The available instance values for inputs.',
});
...
export const TimezoneInputTypeSchema = z.enum([
	...
	name: 'Timezone',
	description: 'The available input types for timezone inputs.',
});
...
).extend(WithTextValidationSchema.shape).meta({
...
).extend(WithArrayValidationSchema.shape).meta({
	name: 'MultiselectInputOptions',
...
export const ArrayInputSchema = BaseInputSchema.extend({
	...
	name: 'ArrayInput',
	description: 'An input type that is an array.',
});
...
export const AutoInputSchema = BaseInputSchema.extend({
	...
	name: 'AutoInput',
	description: 'An input type that has a type which is automatically generated by CloudCannon.',
});
...
export const UnknownInputSchema = BaseInputSchema.extend({
	...
	name: 'UnknownInput',
	description: 'An input type that is not known to the CloudCannon configuration schema. This is logically the same as `AutoInput`, but is used for inputs that are have no type field.',
});
...
export const InputSchema = z.union([KnownInputSchema, UnknownInputSchema]).meta({
	name: 'Input',
	description: 'A union of all input types. This is the type that is used for the `inputs` key in the `collections` key of the `cloudcannon.yml` file.',
});
