...
test('should accept a basic structure', () => {
	const structure = {
		values: [
			{
				value: {
...
test('should accept structure with multiple values', () => {
	const structure = {
		id_key: '_type',
...
test('should accept structure with advanced options', () => {
	const structure = {
...
test('should accept structure without id_key and apply default', () => {
	const structure = {
		values: [
			{
				value: { _type: 'default' },
...
test('should accept a minimal structure value', () => {
...
test('should accept structure value with all options', () => {
	const structureValue = {
		id: 'hero',
		default: true,
		icon: 'star',
...
test('should accept structure value with preview options', () => {
	const structureValue = {
		value: {
			title: 'Card',
		},
...
test('should accept structure value with groups', () => {
	const structureValue = {
		groups: [
			{
				heading: 'Basic Info',
...
test('should accept structure value and validate successfully', () => {
	const structureValue = {
		value: { test: true },
	};
...
test('should accept any value type', () => {
	const values = [
		{ value: 'string' },
		{ value: 42 },
		{ value: true },
