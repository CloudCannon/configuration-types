...
test('should accept a text input', () => {
	const input = {
		type: 'text',
...
test('should accept a textarea input', () => {
	const input = {
		type: 'textarea',
...
test('should accept an email input', () => {
	const input = {
		type: 'email',
...
test('should accept a number input', () => {
	const input = {
		type: 'number',
...
test('should accept a range input', () => {
	const input = {
		type: 'range',
...
test('should accept a checkbox input', () => {
	const input = {
		type: 'checkbox',
...
test('should accept a switch input', () => {
	const input = {
		type: 'switch',
...
test('should accept a select input', () => {
	const input = {
		type: 'select',
...
test('should accept a multiselect input', () => {
	const input = {
		type: 'multiselect',
...
test('should accept a choice input', () => {
	const input = {
		type: 'choice',
...
test('should accept a multichoice input', () => {
	const input = {
		type: 'multichoice',
...
test('should accept a date input', () => {
	const input = {
		type: 'date',
...
test('should accept a datetime input', () => {
	const input = {
		type: 'datetime',
...
test('should accept a time input', () => {
	const input = {
		type: 'time',
...
test('should accept a file input', () => {
	const input = {
		type: 'file',
...
test('should accept an image input', () => {
	const input = {
		type: 'image',
...
test('should accept a document input', () => {
	const input = {
		type: 'document',
...
test('should accept a url input', () => {
	const input = {
		type: 'url',
...
test('should accept an object input', () => {
	const input = {
		type: 'object',
...
test('should accept an array input', () => {
	const input = {
		type: 'array',
		comment: 'Add items',
		options: {
...
test('should accept a code input', () => {
	const input = {
		type: 'code',
		comment: 'Enter code',
		options: {
...
test('should accept a rich_text input', () => {
	const input = {
		type: 'rich_text',
...
test('should accept a color input', () => {
	const input = {
		type: 'color',
...
test('should accept a hidden input', () => {
	const input = {
		type: 'hidden',
...
test('should accept input without type field', () => {
	const input = {
...
test('should accept input with cascade options', () => {
	const input = {
		type: 'text',
...
test('should accept input with context', () => {
	const input = {
		type: 'text',
