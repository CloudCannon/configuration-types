...
test('should accept a valid Jekyll configuration', () => {
	const config = {
...
test('should reject invalid version for Jekyll', () => {
	const config = {
		version: 'latest',
	};
...
test('should accept collections with filter configuration', () => {
	const config = {
		version: 'legacy-jekyll' as const,
		collections_config: {
			posts: {
...
test('should accept a valid Hugo configuration', () => {
	const config = {
...
test('should accept Hugo-specific parse_branch_index option', () => {
	const config = {
		version: 'legacy-hugo' as const,
		collections_config: {
			sections: {
...
test('should accept a valid Eleventy configuration', () => {
	const config = {
...
test('should accept a valid Reader configuration', () => {
	const config = {
...
test('should accept various parser types', () => {
...
test('should reject invalid parser', () => {
	const config = {
		version: 'legacy-reader' as const,
		collections_config: {
			test: {
...
test('should accept filter as string', () => {
	const config = {
		version: 'legacy-jekyll' as const,
		collections_config: {
			posts: {
...
test('should accept filter as object', () => {
	const config = {
		version: 'legacy-hugo' as const,
		collections_config: {
			posts: {
...
test('should reject invalid filter base', () => {
	const config = {
		version: 'legacy-reader' as const,
		collections_config: {
			posts: {
